            ...
            <div
                ...
                <div class="product-inner tooltip-top tooltip-all-top">
                    <div class="product-thumb">
                        <a class="thumb-link" href="{{ route('product', $product->slug) }}" tabindex="0">
                            <img class="img-responsive product-image"
                                src="{{ Storage::url($product->images[0]->path) }}" loading="lazy"
                                alt="{{ $product->name }}T" width="270" height="350">
                        </a>
                        {{-- <div class="flash">
                            <span class="onsale"><span class="number limited fw-bold" style="letter-spacing: 1px;">{{
                    ...
                    <div class="product-info">
                        ...
                        @else
                        <div>
                            <button type="button" class="button btn-warning w-100" disabled>
