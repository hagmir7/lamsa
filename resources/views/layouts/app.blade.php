   ...
   <x-nav />
    ...
    <div class="banner-wrapper my-wrapper has_background">
        ...
        <div class="banner-wrapper-inner">
            <h1 class="page-title">GANDOURA - SAHARA STRIPE</h1>
            <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                <ul class="trail-items breadcrumb">
                    <li class="trail-item trail-begin tajawal"><a href="/"><span>Accueil</span></a></li>
                    <li class="trail-item trail-end active"><span>Détail du produit </span>
                    </li>
                </ul>
            </div>
        </div>
                                    ...
                                    <form class="variations_form cart form-store" data-no-controller="true"
                                        ...
                                        <table class="variations">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                        <div class="data-val attribute-pa_color" data-attributetype="box_style"style=" display:flex ;margin-right: 4px;">
                                        ...
                                        <div class="single_variation_wrap mt-4">
                                            ...
                                            <div class="lynessa-variation-add-to-cart variations_button ">
                                                ...
                                                <div class="payment mt-2 mt-3" style="  margin-bottom: 25px;">
