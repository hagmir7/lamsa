...
class ProductSeeder extends Seeder
{
    public function run()
    {
        ...
        $products = [
            [
                'name' => 'Casual Dress',
                'category_id' => 3, // Assuming 'Dresses' category ID is 3
                'price' => 49.99,
            ...
            [
                'name' => 'Leather Jacket',
                'category_id' => 4, // Assuming 'Jackets' category ID is 4
                'price' => 89.99,
            ...
            [
                'name' => 'Denim Skirt',
                'category_id' => 5, // Assuming 'Skirts' category ID is 5
                'price' => 29.99,
            ...
            [
                ...
                'category_id' => 6, // Assuming 'Sweaters' category ID is 6
                'price' => 34.99,
            ...
            [
                'name' => 'Cargo Shorts',
                'category_id' => 7, // Assuming 'Shorts' category ID is 7
                'price' => 24.99,
            ...
            [
                'name' => 'Silk Blouse',
                'category_id' => 8, // Assuming 'Blouses' category ID is 8
                'price' => 54.99,
